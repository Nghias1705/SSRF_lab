    ...
    try {
        ...
        const usersData = [
            ...
            },
            {
                ...
                profilePicture: 'https://res.cloudinary.com/datvbo0ey/image/upload/v1726651746/3d%20avatar/3_oqqcmg.png',
                coverImage: 'https://img.freepik.com/free-photo/light-background-with-sunset-projector-lamp_53876-128374.jpg'
            },
            {
                ...
                profilePicture: 'https://res.cloudinary.com/datvbo0ey/image/upload/v1726651746/3d%20avatar/5_vqnpgz.png',
                coverImage: 'https://img.freepik.com/free-photo/light-background-with-sunset-projector-lamp_53876-128374.jpg'
            }
        ];
        ...
        const storyContents = [
            { content: 'Đang học Security! 🔐', image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400' },
            { content: 'Coffee time ☕', image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400' },
            { content: 'Coding all night 💻', image: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400' },
            { content: 'Team meeting! 🤝', image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=400' },
            { content: 'Weekend vibes 🎉', image: 'https://images.unsplash.com/photo-1496024840928-4c417adf211d?w=400' }
        ];
        ...
        console.log(`✅ Created post by ${postAuthor.username} tagging all friends`);
        ...
        const commentsToCreate = createdUsers.map((user, index) => ({
            ...
            likes: createdUsers.filter(u => !u._id.equals(user._id)).map(u => u._id) // Everyone except commenter likes the comment
        }));

        await Comment.insertMany(commentsToCreate);
        console.log(`✅ Created ${commentsToCreate.length} comments (each liked by other users)`);
        ...
        console.log(`   📖 Stories: ${storiesToCreate.length} (all active for 24h)`);
